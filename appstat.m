...
static NSURL* topURL(int cType, NSString *countryCode, int limit) {
    return [NSURL URLWithString:[NSString stringWithFormat:@"https://rss.itunes.apple.com/api/v1/%@/ios-apps/top-%@/all/%d/explicit.json", countryCode, cType == 2 ? @"grossing" : cType == 1 ? @"paid" : @"free", limit]];
}
